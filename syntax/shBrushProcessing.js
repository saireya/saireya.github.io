...
SyntaxHighlighter.brushes.Processing = function()
{
	...
	this.regexList = [
		...
		{ regex: new RegExp(this.getKeywords(keywords2), 'gm'),		css: 'color1 bold' },
		{ regex: new RegExp(this.getKeywords(keywords3), 'gm'),		css: 'functions' }
		];
};

SyntaxHighlighter.brushes.Processing.prototype	= new SyntaxHighlighter.Highlighter();
SyntaxHighlighter.brushes.Processing.aliases	= ['Processing', 'processing', 'pde'];
